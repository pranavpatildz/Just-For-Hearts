    ...
    <div className="min-h-screen bg-slate-50">
      ...
      >
        <p className="mt-3 text-gray-700 leading-relaxed">
          This Privacy Policy explains how Just For Hearts Healthcare Private Limited collects,
          uses, discloses, and safeguards your personal information when you use the Just For
          Hearts website and digital services. This includes our website justforhearts.org where
          users can learn about cardiac rehabilitation programs, consult with healthcare
          professionals, book appointments, submit feedback, and access health-related information.
          By using the Website and its services, you agree to the practices described in this
          Privacy Policy.
        </p>
        ...
        <div>
          <motion.h2 {...headingTransition} className="mt-10 border-l-4 border-teal-600 pl-3 text-xl font-semibold tracking-tight text-slate-900 md:text-2xl">Sharing Your Information</motion.h2>
        ...
        <div>
          <motion.h2 {...headingTransition} className="mt-10 border-l-4 border-teal-600 pl-3 text-xl font-semibold tracking-tight text-slate-900 md:text-2xl">Data Security</motion.h2>
        ...
        <div>
          <motion.h2 {...headingTransition} className="mt-10 border-l-4 border-teal-600 pl-3 text-xl font-semibold tracking-tight text-slate-900 md:text-2xl">Data Retention</motion.h2>
        ...
        <div>
          <motion.h2 {...headingTransition} className="mt-10 border-l-4 border-teal-600 pl-3 text-xl font-semibold tracking-tight text-slate-900 md:text-2xl">Your Rights and Choices</motion.h2>
        ...
        <div>
          <motion.h2 {...headingTransition} className="mt-10 border-l-4 border-teal-600 pl-3 text-xl font-semibold tracking-tight text-slate-900 md:text-2xl">Children&apos;s Privacy</motion.h2>
        ...
        <div>
          <motion.h2 {...headingTransition} className="mt-10 border-l-4 border-teal-600 pl-3 text-xl font-semibold tracking-tight text-slate-900 md:text-2xl">Links to Other Websites</motion.h2>
        ...
        <div>
          <motion.h2 {...headingTransition} className="mt-10 border-l-4 border-teal-600 pl-3 text-xl font-semibold tracking-tight text-slate-900 md:text-2xl">Changes to this Privacy Policy</motion.h2>
        ...
        <div>
          <motion.h2 {...headingTransition} className="mt-10 border-l-4 border-teal-600 pl-3 text-xl font-semibold tracking-tight text-slate-900 md:text-2xl">Contact Us</motion.h2>
